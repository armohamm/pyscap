...
@attribute(local_name='shape', type=defer_class_load('scap.model.xhtml.ShapeType', 'ShapeType'), default='rect')
@attribute(local_name='coords', type=defer_class_load('scap.model.xhtml.CoordsType', 'CoordsType'))
