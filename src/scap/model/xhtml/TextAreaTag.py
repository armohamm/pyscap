...
@attribute(local_name='rows', type=('scap.model.xhtml.NumberType', 'NumberType'), required=True)
@attribute(local_name='cols', type=('scap.model.xhtml.NumberType', 'NumberType'), required=True)
