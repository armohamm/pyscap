...
@attribute(local_name='abbr', type=('scap.model.xhtml.TextType', 'TextType'))
...
@attribute(local_name='rowspan', type=('scap.model.xhtml.NumberType', 'NumberType'), default=1)
@attribute(local_name='colspan', type=('scap.model.xhtml.NumberType', 'NumberType'), default=1)
...
@attribute(local_name='char', type=('scap.model.xhtml.CharacterType', 'CharacterType'))
@attribute(local_name='charoff', type=('scap.model.xhtml.LengthType', 'LengthType'))
