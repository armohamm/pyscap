...
@attribute(local_name='cite', type=defer_class_load('scap.model.xhtml.UriType', 'UriType'))
@attribute(local_name='datetime', type=defer_class_load('scap.model.xhtml.DateTimeType', 'DateTimeType'))
