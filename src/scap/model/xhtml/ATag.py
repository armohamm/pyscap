...
from .AContentType import AContentType
...
@attribute(local_name='hreflang', type=('scap.model.xhtml.LanguageCodeType', 'LanguageCodeType'))
@attribute(local_name='rel', type=('scap.model.xhtml.LinkTypesType', 'LinkTypesType'))
@attribute(local_name='rev', type=('scap.model.xhtml.LinkTypesType', 'LinkTypesType'))
@attribute(local_name='shape', type=('scap.model.xhtml.ShapeType', 'ShapeType'), default='rect')
@attribute(local_name='coords', type=('scap.model.xhtml.CoordsType', 'CoordsType'))
