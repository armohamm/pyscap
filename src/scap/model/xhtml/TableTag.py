...
@attribute(local_name='summary', type=('scap.model.xhtml.TextType', 'TextType'))
@attribute(local_name='width', type=('scap.model.xhtml.LengthType', 'LengthType'))
@attribute(local_name='border', type=('scap.model.xhtml.PixelsType', 'PixelsType'))
@attribute(local_name='frame', enum=T_FRAME_ENUMERATION)
@attribute(local_name='rules', enum=T_RULES_ENUMERATION)
@attribute(local_name='cellspacing', type=('scap.model.xhtml.LengthType', 'LengthType'))
@attribute(local_name='cellpadding', type=('scap.model.xhtml.LengthType', 'LengthType'))
...
@element(local_name='caption', type=('scap.model.xhtml.CaptionTag', 'CaptionTag'), min=0)
@element(local_name='col', type=('scap.model.xhtml.ColTag', 'ColTag'), min=0, max=None)
@element(local_name='colgroup', type=('scap.model.xhtml.ColGroupTag', 'ColGroupTag'), min=0, max=None)
@element(local_name='thead', type=('scap.model.xhtml.THeadTag', 'THeadTag'), min=0)
@element(local_name='tfoot', type=('scap.model.xhtml.TFootTag', 'TFootTag'), min=0)
@element(local_name='tbody', type=('scap.model.xhtml.TBodyTag', 'TBodyTag'), min=0, max=None)
@element(local_name='tr', type=('scap.model.xhtml.TRTag', 'TRTag'), min=0, max=None)
