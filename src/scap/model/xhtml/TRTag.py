...
@element(local_name='th', list='_elements', cls=('scap.model.xhtml.THTag', 'THTag'), max=None)
@element(local_name='td', list='_elements', cls=('scap.model.xhtml.TDTag', 'TDTag'), max=None)
class TRTag(Model):
    pass
