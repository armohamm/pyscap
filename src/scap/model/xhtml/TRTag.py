...
@element(local_name='th', list='_elements', cls=defer_class_load('scap.model.xhtml.THTag', 'THTag'), max=None)
@element(local_name='td', list='_elements', cls=defer_class_load('scap.model.xhtml.TDTag', 'TDTag'), max=None)
class TRTag(Model):
    pass
