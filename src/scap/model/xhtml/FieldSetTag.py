...
@element(local_name='legend', list='_elements', cls=('scap.model.xhtml.LegendTag', 'LegendTag'))
...
@element(local_name='form', list='_elements', cls=('scap.model.xhtml.FormTag', 'FormTag'))
