...
@element(local_name='legend', list='_elements', cls=defer_class_load('scap.model.xhtml.LegendTag', 'LegendTag'))
...
@element(local_name='form', list='_elements', cls=defer_class_load('scap.model.xhtml.FormTag', 'FormTag'))
