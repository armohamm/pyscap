...
@attribute(local_name='onload', type=defer_class_load('scap.model.xhtml.ScriptType', 'ScriptType'))
@attribute(local_name='onunload', type=defer_class_load('scap.model.xhtml.ScriptType', 'ScriptType'))
