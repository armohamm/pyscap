...
@attribute(local_name='span', type=('scap.model.xhtml.NumberType', 'NumberType'), default=1)
@attribute(local_name='width', type=('scap.model.xhtml.MultiLengthType', 'MultiLengthType'))
