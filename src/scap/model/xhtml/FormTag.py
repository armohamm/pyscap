...
@attribute(local_name='action', type=('scap.model.xhtml.UriType', 'UriType'), required=True)
@attribute(local_name='method', enum=['get', 'post'], default='get')
@attribute(local_name='enctype', type=('scap.model.xhtml.ContentTypeType', 'ContentTypeType'), default='application/x-www-form-urlencoded')
@attribute(local_name='onsubmit', type=('scap.model.xhtml.ScriptType', 'ScriptType'))
@attribute(local_name='onreset', type=('scap.model.xhtml.ScriptType', 'ScriptType'))
@attribute(local_name='accept', type=('scap.model.xhtml.ContentTypesType', 'ContentTypesType'))
@attribute(local_name='accept-charset', type=('scap.model.xhtml.CharsetsType', 'CharsetsType'))
