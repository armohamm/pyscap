...
@attribute(local_name='size', type=('scap.model.xhtml.NumberType', 'NumberType'))
...
@element(local_name='optgroup', list='_elements', cls=('scap.model.xhtml.OptGroupTag', 'OptGroupTag'), max=None)
@element(local_name='option', list='_elements', cls=('scap.model.xhtml.OptionTag', 'OptionTag'), max=None)
