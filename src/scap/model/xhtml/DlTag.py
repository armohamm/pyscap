...
@element(local_name='dt', list='_elements', cls=defer_class_load('scap.model.xhtml.LiTag', 'LiTag'), max=None)
@element(local_name='dd', list='_elements', cls=defer_class_load('scap.model.xhtml.LiTag', 'LiTag'), max=None)
class DlTag(Model):
    pass
