...
@element(local_name='service_query_conf', max=1, min=0, cls=scap.model.oval_5.sc.EntityItemType)
@element(local_name='service_change_conf', max=1, min=0, cls=scap.model.oval_5.sc.EntityItemType)
@element(local_name='service_query_stat', max=1, min=0, cls=scap.model.oval_5.sc.EntityItemType)
@element(local_name='service_enum_dependents', max=1, min=0, cls=scap.model.oval_5.sc.EntityItemType)
@element(local_name='service_start', max=1, min=0, cls=scap.model.oval_5.sc.EntityItemType)
@element(local_name='service_stop', max=1, min=0, cls=scap.model.oval_5.sc.EntityItemType)
@element(local_name='service_pause', max=1, min=0, cls=scap.model.oval_5.sc.EntityItemType)
@element(local_name='service_interrogate', max=1, min=0, cls=scap.model.oval_5.sc.EntityItemType)
@element(local_name='service_user_defined', max=1, min=0, cls=scap.model.oval_5.sc.EntityItemType)
        ],
        'attributes': {
        },
    }
