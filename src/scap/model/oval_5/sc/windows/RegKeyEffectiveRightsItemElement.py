...
@element(local_name='key_query_value', max=1, min=0, cls=EntityItemType)
@element(local_name='key_set_value', max=1, min=0, cls=EntityItemType)
@element(local_name='key_create_sub_key', max=1, min=0, cls=EntityItemType)
@element(local_name='key_enumerate_sub_keys', max=1, min=0, cls=EntityItemType)
@element(local_name='key_notify', max=1, min=0, cls=EntityItemType)
@element(local_name='key_create_link', max=1, min=0, cls=EntityItemType)
@element(local_name='key_wow64_64key', max=1, min=0, cls=EntityItemType)
@element(local_name='key_wow64_32key', max=1, min=0, cls=EntityItemType)
@element(local_name='key_wow64_res', max=1, min=0, cls=EntityItemType)
