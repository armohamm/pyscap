...
@element(local_name='file_read_data', max=1, min=0, cls=EntityItemAuditType)
@element(local_name='file_write_data', max=1, min=0, cls=EntityItemAuditType)
@element(local_name='file_append_data', max=1, min=0, cls=EntityItemAuditType)
@element(local_name='file_read_ea', max=1, min=0, cls=EntityItemAuditType)
@element(local_name='file_write_ea', max=1, min=0, cls=EntityItemAuditType)
@element(local_name='file_execute', max=1, min=0, cls=EntityItemAuditType)
@element(local_name='file_delete_child', max=1, min=0, cls=EntityItemAuditType)
