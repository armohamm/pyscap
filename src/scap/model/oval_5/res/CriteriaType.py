...
@element(local_name='criterion', list='criteria', cls=defer_class_load('scap.model.oval_5.defs.CriterionType', 'CriterionType'), min=0, max=None)
@element(local_name='extend_definition', list='criteria', cls=defer_class_load('scap.model.oval_5.defs.ExtendDefinitionType', 'ExtendDefinitionType'), min=0, max=None)
