...
@element(local_name='md5', cls='scap.model.oval_5.defs.EntityStateType', min=0, max=1)
@element(local_name='sha1', cls='scap.model.oval_5.defs.EntityStateType', min=0, max=1)
