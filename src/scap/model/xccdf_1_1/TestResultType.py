...
@element(local_name='set-value', dict='set_values', cls=ProfileSetValueType, dict_key='idref', min=0, max=None)
@element(local_name='rule-result', dict='rule_results', cls=RuleResultType, dict_key='idref', min=0, max=None)
