...
@element(local_name='value', cls=SelStringType, dict='values', dict_key='selector', min=1, max=None)
@element(local_name='default', cls=SelStringType, dict='defaults', dict_key='selector', min=0, max=None)
...
@element(local_name='choices', cls=SelChoicesType, dict='choice_selections', dict_key='selector', min=0, max=None)
