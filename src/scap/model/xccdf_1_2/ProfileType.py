...
@element\(local_name='select', cls=ProfileSelectType, dict='selects', dict_key='idref', min=0, max=None)
@element\(local_name='set-complex-value', cls=ProfileSetComplexValueType, dict='set_complex_values', dict_key='idref', min=0, max=None)
@element\(local_name='set-value', cls=ProfileSetValueType, dict='set_values', dict_key='idref', min=0, max=None)
@element\(local_name='refine-value', cls=ProfileRefineValueType, dict='refine_values', dict_key='idref', min=0, max=None)
@element\(local_name='refine-rule', cls=ProfileRefineRuleType, dict='refine_rules', dict_key='idref', min=0, max=None)
