...
class IfListenersStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            {'tag_name': 'interface_name', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'protocol', 'class': 'EntityStateProtocolType', 'min': 0, 'max': 1},
            {'tag_name': 'hw_address', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0, 'max': 1},
