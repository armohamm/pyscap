...
class SeLinuxBooleanStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'current_status', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'pending_status', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
        ],
    }
