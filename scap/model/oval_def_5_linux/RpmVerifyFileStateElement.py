...
class RpmVerifyFileStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            {'tag_name': 'name', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0, 'max': 1},
            ...
            {'tag_name': 'arch', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'filepath', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'extended_name', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0, 'max': 1},
            ...
            {'tag_name': 'configuration_file', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0, 'max': 1},
            {'tag_name': 'documentation_file', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0, 'max': 1},
            {'tag_name': 'ghost_file', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0, 'max': 1},
            {'tag_name': 'license_file', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0, 'max': 1},
            {'tag_name': 'readme_file', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0, 'max': 1},
        ],
    }
