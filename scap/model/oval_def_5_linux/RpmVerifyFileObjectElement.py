...
class RpmVerifyFileObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'name', 'class': 'scap.model.oval_def_5.EntityObjectStringType', 'min': 0, 'max': 1},
            ...
            {'tag_name': 'arch', 'class': 'scap.model.oval_def_5.EntityObjectStringType', 'min': 0, 'max': 1},
            {'tag_name': 'filepath', 'class': 'scap.model.oval_def_5.EntityObjectStringType', 'min': 0, 'max': 1},
