...
class DpkgInfoStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            {'tag_name': 'name', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0, 'max': None},
            {'tag_name': 'arch', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0, 'max': None},
