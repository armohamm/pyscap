...
class RpmInfoStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'evr', 'class': 'scap.model.oval_def_5.EntityStateEVRStringType', 'min': 0, 'max': 1},
            {'tag_name': 'signature_keyid', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0, 'max': 1},
