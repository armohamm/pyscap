...
class CmdletObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'module_name', 'class': 'scap.model.oval_def_5.EntityObjectStringType', 'nillable': True, 'min': 1, 'max': 1},
            ...
            {'tag_name': 'noun', 'class': 'scap.model.oval_def_5.EntityObjectStringType', 'nillable': True, 'min': 1, 'max': 1},
            {'tag_name': 'parameters', 'class': 'scap.model.oval_def_5.EntityObjectRecordType', 'nillable': True},
            {'tag_name': 'select', 'class': 'scap.model.oval_def_5.EntityObjectRecordType', 'nillable': True},
            {'xmlns': 'http://oval.mitre.org/XMLSchema/oval-definitions-5', 'tag_name': 'filter', 'class': 'scap.model.oval_def_5.FilterElement', 'min': 0, 'max': None},
        ],
    }
