...
class PrinterEffectiveRightsStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            {'tag_name': 'printer_name', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0},
            ...
            {'tag_name': 'printer_access_administer', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'printer_access_use', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'job_access_administer', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'job_access_read', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
        ],
    }
