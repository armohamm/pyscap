...
class RegKeyEffectiveRightsStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'key', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0},
            ...
            {'tag_name': 'key_query_value', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'key_set_value', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'key_create_sub_key', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'key_enumerate_sub_keys', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'key_notify', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'key_create_link', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'key_wow64_64key', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'key_wow64_32key', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'key_wow64_res', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
