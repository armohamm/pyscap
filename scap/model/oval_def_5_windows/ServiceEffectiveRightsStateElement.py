...
class ServiceEffectiveRightsStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            {'tag_name': 'service_name', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0},
            ...
            {'tag_name': 'service_query_conf', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'service_change_conf', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'service_query_stat', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'service_enum_dependents', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'service_start', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'service_stop', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'service_pause', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'service_interrogate', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'service_user_defined', 'class': 'scap.model.oval_def_5.EntityStateBoolType', 'min': 0},
        ],
    }
