...
class XMLFileContentStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'xpath', 'class': 'scap.model.oval_defs_5.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'value_of', 'class': 'scap.model.oval_defs_5.EntityStateAnySimpleType', 'min': 0, 'max': 1},
