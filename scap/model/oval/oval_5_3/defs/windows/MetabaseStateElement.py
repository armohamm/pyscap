...
class MetabaseStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'id', 'class': 'scap.model.oval.oval_5_3.defs.EntityStateIntType', 'min': 0},
            {'tag_name': 'name', 'class': 'scap.model.oval.oval_5_3.defs.EntityStateStringType', 'min': 0},
            {'tag_name': 'user_type', 'class': 'scap.model.oval.oval_5_3.defs.EntityStateStringType', 'min': 0},
            {'tag_name': 'data_type', 'class': 'scap.model.oval.oval_5_3.defs.EntityStateStringType', 'min': 0},
            {'tag_name': 'data', 'class': 'scap.model.oval.oval_5_3.defs.EntityStateAnyType', 'min': 0},
        ],
    }
