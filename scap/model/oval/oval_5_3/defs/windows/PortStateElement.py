...
class PortStateElement(StateType):
    MODEL_MAP = {
        'tag_name': 'port_state',
        'elements': [
            {'tag_name': 'local_address', 'class': 'scap.model.oval.oval_5_3.defs.EntityStateIPAddressStringType', 'min': 0},
            {'tag_name': 'local_port', 'class': 'scap.model.oval.oval_5_3.defs.EntityStateIntType', 'min': 0},
