...
class ActiveDirectoryObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'relative_dn', 'class': 'scap.model.oval.oval_5_3.defs.EntityObjectStringType', 'nillable': True, 'min': 0},
            {'tag_name': 'attribute', 'class': 'scap.model.oval.oval_5_3.defs.EntityObjectStringType', 'nillable': True, 'min': 0},
        ],
    }
