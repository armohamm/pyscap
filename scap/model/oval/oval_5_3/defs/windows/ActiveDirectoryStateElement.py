...
class ActiveDirectoryStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'relative_dn', 'class': 'scap.model.oval.oval_5_3.defs.EntityStateStringType', 'min': 0},
            {'tag_name': 'attribute', 'class': 'scap.model.oval.oval_5_3.defs.EntityStateStringType', 'min': 0},
            {'tag_name': 'object_class', 'class': 'scap.model.oval.oval_5_3.defs.EntityStateStringType', 'min': 0},
