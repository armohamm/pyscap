...
class TextFileContentStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'line', 'class': 'scap.model.oval.oval_5_3.defs.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'subexpression', 'class': 'scap.model.oval.oval_5_3.defs.EntityStateAnyType', 'min': 0, 'max': 1},
        ],
    }
