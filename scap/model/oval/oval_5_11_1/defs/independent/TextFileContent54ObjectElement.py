...
class TextFileContent54ObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'pattern', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectStringType'},
            {'tag_name': 'instance', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectIntType'},
