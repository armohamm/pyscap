...
class SystemDUnitPropertyStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            {'tag_name': 'unit', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'property', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'value', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateAnySimpleType', 'min': 0, 'max': 1},
        ],
    }
