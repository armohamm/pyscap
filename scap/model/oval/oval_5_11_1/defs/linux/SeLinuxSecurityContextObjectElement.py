...
class SeLinuxSecurityContextObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'filename', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectStringType', 'nillable': True},
            {'tag_name': 'pid', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectIntType', 'nillable': True},
