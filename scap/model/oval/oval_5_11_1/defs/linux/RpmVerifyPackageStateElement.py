...
class RpmVerifyPackageStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'dependency_check_passed', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0, 'max': 1},
            {'tag_name': 'digest_check_passed', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0, 'max': 1},
            {'tag_name': 'verification_script_successful', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0, 'max': 1},
            {'tag_name': 'signature_check_passed', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0, 'max': 1},
        ],
    }
