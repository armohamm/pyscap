...
class SlackwarePkgInfoStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'version', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'architecture', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'revision', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0, 'max': 1},
        ],
    }
