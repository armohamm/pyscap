...
class WmiObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'namespace', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectStringType'},
            {'tag_name': 'wql', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectStringType'},
        ],
    }
