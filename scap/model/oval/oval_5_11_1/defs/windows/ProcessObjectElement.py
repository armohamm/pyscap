...
class ProcessObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            {'xmlns': 'http://oval.mitre.org/XMLSchema/oval-definitions-5', 'tag_name': 'set', 'class': 'scap.model.oval.oval_5_11_1.defs.SetElement', 'min': 0, 'min': 0},
            {'tag_name': 'command_line', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectStringType'},
        ],
    }
