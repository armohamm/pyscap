...
class WuaUpdateSearcherStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            {'tag_name': 'search_criteria', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0},
            {'tag_name': 'update_id', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0},
        ],
    }
