...
class InterfaceStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'index', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateIntType', 'min': 0},
            {'tag_name': 'type', 'class': 'EntityStateInterfaceTypeType', 'min': 0},
            {'tag_name': 'hardware_addr', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0},
            {'tag_name': 'inet_addr', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateIPAddressStringType', 'min': 0},
            {'tag_name': 'broadcast_addr', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateIPAddressStringType', 'min': 0},
            {'tag_name': 'netmask', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateIPAddressStringType', 'min': 0},
