...
class FileEffectiveRights53StateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'file_read_data', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0},
            {'tag_name': 'file_write_data', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0},
            {'tag_name': 'file_append_data', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0},
            {'tag_name': 'file_read_ea', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0},
            {'tag_name': 'file_write_ea', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0},
            {'tag_name': 'file_execute', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0},
            {'tag_name': 'file_delete_child', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0},
            {'tag_name': 'file_read_attributes', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0},
            {'tag_name': 'file_write_attributes', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateBoolType', 'min': 0},
