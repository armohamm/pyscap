...
from scap.model.oval.oval_5_11_1.defs_linux.ObjectType import ObjectType
...
class RpmVerifyFileObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'name', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectStringType', 'min': 0, 'max': 1},
            ...
            {'tag_name': 'arch', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectStringType', 'min': 0, 'max': 1},
            {'tag_name': 'filepath', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectStringType', 'min': 0, 'max': 1},
