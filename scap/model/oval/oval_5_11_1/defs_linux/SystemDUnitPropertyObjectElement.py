...
class SystemDUnitPropertyObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'unit', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectStringType'},
            {'tag_name': 'property', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectStringType'},
