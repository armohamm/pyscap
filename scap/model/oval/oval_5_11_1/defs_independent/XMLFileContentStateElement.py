...
class XMLFileContentStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'xpath', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'value_of', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateAnySimpleType', 'min': 0, 'max': 1},
