...
class TextFileContent54StateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'pattern', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'instance', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateIntType', 'min': 0, 'max': 1},
            {'tag_name': 'text', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateAnySimpleType', 'min': 0, 'max': 1},
            {'tag_name': 'subexpression', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateAnySimpleType', 'min': 0, 'max': 1},
