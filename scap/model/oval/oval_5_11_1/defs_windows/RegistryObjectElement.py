...
class RegistryObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            {'xmlns': 'http://oval.mitre.org/XMLSchema/oval-definitions-5', 'tag_name': 'set', 'class': 'scap.model.oval.oval_5_11_1.defs.SetElement', 'min': 0, 'max': 1},
            {'tag_name': 'behaviors', 'class': 'RegistryBehaviors', 'min': 0},
            {'tag_name': 'hive', 'class': 'EntityObjectRegistryHiveType'},
            {'tag_name': 'key', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectStringType', 'nillable': True},
            {'tag_name': 'name', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityObjectStringType', 'nillable': True},
