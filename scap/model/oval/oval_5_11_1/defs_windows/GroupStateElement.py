...
class GroupStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            {'tag_name': 'group', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0},
            {'tag_name': 'user', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0},
            {'tag_name': 'subgroup', 'class': 'scap.model.oval.oval_5_11_1.defs.EntityStateStringType', 'min': 0},
        ],
    }
