...
class TextFileContent54StateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'pattern', 'class': 'scap.model.oval_def_5.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'instance', 'class': 'scap.model.oval_def_5.EntityStateIntType', 'min': 0, 'max': 1},
            {'tag_name': 'text', 'class': 'scap.model.oval_def_5.EntityStateAnySimpleType', 'min': 0, 'max': 1},
            {'tag_name': 'subexpression', 'class': 'scap.model.oval_def_5.EntityStateAnySimpleType', 'min': 0, 'max': 1},
