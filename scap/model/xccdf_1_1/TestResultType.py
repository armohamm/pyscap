...
class TestResultType(Model):
    MODEL_MAP = {
        'elements': [
            ...
            {'tag_name': 'organization', 'list': 'organizations', 'type': 'String', 'min': 0, 'max': None},
            {'tag_name': 'identity', 'class': 'IdentityType', 'min': 0, 'max': 1},
            {'tag_name': 'profile', 'class': 'IdrefType', 'min': 0, 'max': 1},
            {'tag_name': 'target', 'list': 'targets', 'type': 'String', 'min': 1, 'max': None},
            {'tag_name': 'target-address', 'list': 'target_addresses', 'type': 'String', 'min': 0, 'max': None},
