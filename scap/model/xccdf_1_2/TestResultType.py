...
class TestResultType(Model):
    MODEL_MAP = {
        ...
        'elements': {
            ...
            '{http://checklists.nist.gov/xccdf/1.2}title': {'class': 'TextType', 'append': 'titles', 'min': 0, 'max': None},
            '{http://checklists.nist.gov/xccdf/1.2}remark': {'class': 'TextType', 'append': 'remarks', 'min': 0, 'max': None},
            '{http://checklists.nist.gov/xccdf/1.2}organization': {'type': 'String', 'append': 'organizations', 'min': 0, 'max': None},
            '{http://checklists.nist.gov/xccdf/1.2}identity': {'class': 'IdentityType', 'min': 0, 'max': 1},
            '{http://checklists.nist.gov/xccdf/1.2}profile': {'class': 'IDRefType', 'min': 0, 'max': 1},
            '{http://checklists.nist.gov/xccdf/1.2}target': {'type': 'String', 'append': 'targets', 'min': 1, 'max': None},
            '{http://checklists.nist.gov/xccdf/1.2}target-address': {'type': 'String', 'append': 'target_addresses', 'min': 0, 'max': None},
            '{http://checklists.nist.gov/xccdf/1.2}target-facts': {'class': 'TargetFactsType', 'append': 'target_facts', 'min': 0, 'max': None},
            '{http://checklists.nist.gov/xccdf/1.2}target-id-ref': {'class': 'TargetIDRefType', 'append': 'target_id_refs', 'min': 0, 'max': None},
            '*': {'min': 0, 'max': None},
            '{http://checklists.nist.gov/xccdf/1.2}platform': {'class': 'CPE2IDRefType', 'append': 'platforms', 'min': 0, 'max': None},
