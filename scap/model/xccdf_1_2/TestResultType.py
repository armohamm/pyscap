...
class TestResultType(Model):
    MODEL_MAP = {
        ...
        'elements': [
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'benchmark', 'class': 'BenchmarkReferenceType', 'min': 0, 'max': 1},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'tailoring-file', 'class': 'TailoringReferenceType', 'min': 0, 'max': 1},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'title', 'class': 'TextType', 'append': 'titles', 'min': 0, 'max': None},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'remark', 'class': 'TextType', 'append': 'remarks', 'min': 0, 'max': None},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'organization', 'type': 'String', 'append': 'organizations', 'min': 0, 'max': None},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'identity', 'class': 'IdentityType', 'min': 0, 'max': 1},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'profile', 'class': 'IDRefType', 'min': 0, 'max': 1},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'target', 'type': 'String', 'append': 'targets', 'min': 1, 'max': None},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'target-address', 'type': 'String', 'append': 'target_addresses', 'min': 0, 'max': None},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'target-facts', 'class': 'TargetFactsType', 'append': 'target_facts', 'min': 0, 'max': None},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'target-id-ref', 'class': 'TargetIDRefType', 'append': 'target_id_refs', 'min': 0, 'max': None},{'tag_name': '*', 'min': 0, 'max': None},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'platform', 'class': 'CPE2IDRefType', 'append': 'platforms', 'min': 0, 'max': None},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'set-value', 'class': 'ProfileSetValueType', 'map': 'set_values', 'key': 'idref', 'min': 0, 'max': None},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'set-complex-value', 'class': 'ProfileSetComplexValueType', 'map': 'set_values', 'key': 'idref', 'min': 0, 'max': None},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'rule-result', 'class': 'RuleResultType', 'map': 'rule_results', 'key': 'idref', 'min': 0, 'max': None},
            {'xml_namespace': 'http://checklists.nist.gov/xccdf/1.2', 'tag_name': 'score', 'class': 'ScoreType', 'append': 'scores', 'min': 1, 'max': None},
