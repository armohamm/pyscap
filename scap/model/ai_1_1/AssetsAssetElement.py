...
class AssetsAssetElement(Model):
    MODEL_MAP = {
        ...
        'element_order': [
            '{http://scap.nist.gov/schema/asset-identification/1.1}circuit',
            '{http://scap.nist.gov/schema/asset-identification/1.1}computing-device',
            '{http://scap.nist.gov/schema/asset-identification/1.1}data',
            '{http://scap.nist.gov/schema/asset-identification/1.1}database',
            '{http://scap.nist.gov/schema/asset-identification/1.1}network',
            '{http://scap.nist.gov/schema/asset-identification/1.1}organization',
            '{http://scap.nist.gov/schema/asset-identification/1.1}person',
            '{http://scap.nist.gov/schema/asset-identification/1.1}service',
            '{http://scap.nist.gov/schema/asset-identification/1.1}software',
            '{http://scap.nist.gov/schema/asset-identification/1.1}system',
            '{http://scap.nist.gov/schema/asset-identification/1.1}website',
        ],
        'attributes': {
