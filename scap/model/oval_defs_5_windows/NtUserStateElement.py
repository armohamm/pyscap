...
class NtUserStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'sid', 'class': 'scap.model.oval_defs_5.EntityStateStringType', 'min': 0},
            {'tag_name': 'username', 'class': 'scap.model.oval_defs_5.EntityStateStringType', 'min': 0},
            {'tag_name': 'account_type', 'class': 'EntityStateNTUserAccountTypeType', 'min': 0},
            {'tag_name': 'logged_on', 'class': 'scap.model.oval_defs_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'enabled', 'class': 'scap.model.oval_defs_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'date_modified', 'class': 'scap.model.oval_defs_5.EntityStateIntType', 'min': 0},
            {'tag_name': 'days_since_modified', 'class': 'scap.model.oval_defs_5.EntityStateIntType', 'min': 0},
            ...
            {'tag_name': 'type', 'class': 'scap.model.oval_defs_5.EntityStateRegistryTypeType', 'min': 0},
