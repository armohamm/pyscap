...
class ServiceStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'display_name', 'class': 'oval_defs_5.EntityStateStringType', 'min': 0},
            {'tag_name': 'description', 'class': 'oval_defs_5.EntityStateStringType', 'min': 0},
            ...
            {'tag_name': 'start_name', 'class': 'oval_defs_5.EntityStateStringType', 'min': 0},
            {'tag_name': 'path', 'class': 'oval_defs_5.EntityStateStringType', 'min': 0},
            {'tag_name': 'pid', 'class': 'oval_defs_5.EntityStateIntType', 'min': 0},
            {'tag_name': 'service_flag', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
            {'tag_name': 'dependencies', 'class': 'oval_defs_5.EntityStateStringType', 'min': 0},
        ],
    }
