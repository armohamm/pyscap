...
class WuaUpdateSearcherObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'behaviors', 'class': 'WuaUpdateSearcherBehaviors', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'search_criteria', 'class': 'oval_defs_5.EntityObjectStringType'},
