...
class SharedResourceAuditedPermissionsObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'behaviors', 'class': 'SharedResourceAuditedPermissionsBehaviors', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'netname', 'class': 'oval_defs_5.EntityObjectStringType'},
