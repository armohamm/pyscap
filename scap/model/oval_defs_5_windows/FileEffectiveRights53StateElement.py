...
class FileEffectiveRights53StateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'standard_synchronize', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'access_system_security', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
            ...
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'generic_all', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'file_read_data', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'file_write_data', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'file_append_data', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'file_read_ea', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'file_write_ea', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'file_execute', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'file_delete_child', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'file_read_attributes', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'file_write_attributes', 'class': 'oval_defs_5.EntityStateBoolType', 'min': 0},
