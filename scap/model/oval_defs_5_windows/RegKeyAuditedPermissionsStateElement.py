...
class RegKeyAuditedPermissionsStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'standard_write_owner', 'class': 'EntityStateAuditType'},
            ...
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'key_query_value', 'class': 'EntityStateAuditType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'key_set_value', 'class': 'EntityStateAuditType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'key_create_sub_key', 'class': 'EntityStateAuditType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'key_enumerate_sub_keys', 'class': 'EntityStateAuditType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'key_notify', 'class': 'EntityStateAuditType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'key_create_link', 'class': 'EntityStateAuditType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'key_wow64_64key', 'class': 'EntityStateAuditType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'key_wow64_32key', 'class': 'EntityStateAuditType', 'min': 0},
            {'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows', 'tag_name': 'key_wow64_res', 'class': 'EntityStateAuditType', 'min': 0},
