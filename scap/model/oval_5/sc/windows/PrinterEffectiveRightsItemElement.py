...
class PrinterEffectiveRightsItemElement(ItemType):
    MODEL_MAP = {
        'elements': [
            {'tag_name': 'printer_name', 'max': 1, 'min': 0, 'class': 'scap.model.oval_5.sc.EntityItemStringType'},
            ...
            {'tag_name': 'printer_access_administer', 'max': 1, 'min': 0, 'class': 'scap.model.oval_5.sc.EntityItemBoolType'},
            {'tag_name': 'printer_access_use', 'max': 1, 'min': 0, 'class': 'scap.model.oval_5.sc.EntityItemBoolType'},
            {'tag_name': 'job_access_administer', 'max': 1, 'min': 0, 'class': 'scap.model.oval_5.sc.EntityItemBoolType'},
            {'tag_name': 'job_access_read', 'max': 1, 'min': 0, 'class': 'scap.model.oval_5.sc.EntityItemBoolType'},
        ],
        'attributes': {
        },
    }
