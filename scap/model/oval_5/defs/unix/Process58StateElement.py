...
class Process58StateElement(StateType):
    MODEL_MAP = {
        'elements': [
            {'tag_name': 'command_line', 'class': 'scap.model.oval_5.defs.EntityStateStringType', 'min': 0, 'max': 1},
            ...
            {'tag_name': 'exec_shield', 'class': 'scap.model.oval_5.defs.EntityStateBoolType', 'min': 0, 'max': 1},
            {'tag_name': 'loginuid', 'class': 'scap.model.oval_5.defs.EntityStateIntType', 'min': 0, 'max': 1},
            {'tag_name': 'posix_capability', 'class': 'EntityStateCapabilityType', 'min': 0, 'max': 1},
            {'tag_name': 'selinux_domain_label', 'class': 'scap.model.oval_5.defs.EntityStateStringType', 'min': 0, 'max': 1},
            {'tag_name': 'session_id', 'class': 'scap.model.oval_5.defs.EntityStateIntType', 'min': 0, 'max': 1},
        ],
        'attributes': {
        },
    }
