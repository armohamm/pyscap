...
class Process58StateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'creation_time', 'class': 'scap.model.oval_5.defs.EntityStateIntType', 'min': 0},
            {'tag_name': 'dep_enabled', 'class': 'scap.model.oval_5.defs.EntityStateBoolType', 'min': 0},
            {'tag_name': 'primary_window_text', 'class': 'scap.model.oval_5.defs.EntityStateStringType', 'min': 0},
