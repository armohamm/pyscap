...
class RpmVerifyFileObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': [
            ...
            {'tag_name': 'arch', 'class': 'scap.model.oval_defs_5.EntityObjectStringType', 'min': 0, 'max': 1},
            {'tag_name': 'filepath', 'class': 'scap.model.oval_defs_5.EntityObjectStringType', 'min': 0, 'max': 1},
