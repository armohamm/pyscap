...
def test_existing_file_equals():
    filepath = str(pathlib.Path(str(pytest.config.rootdir)) / 'test' / 'scap' / 'model' / 'test_xlink.xml')
...
def test_existing_file_pattern():
    regexfilepath = str(pathlib.Path(str(pytest.config.rootdir)) / 'test' / 'scap' / 'model' / '.*xlink.xml').replace('\\', '\\\\')
    filepath = str(pathlib.Path(str(pytest.config.rootdir)) / 'test' / 'scap' / 'model' / 'test_xlink.xml')
    c = host.load_collector('ResolveFilepathCollector', {
...
def test_existing_dir_equals():
    filepath = str(pathlib.Path(str(pytest.config.rootdir)) / 'test' / 'scap' / 'model')
    c = host.load_collector('ResolveFilepathCollector', {
        'filepath': filepath,
        'value_datatypes': {'filepath': 'string'},
        'value_operations': {'filepath': 'equals'},
...
def test_not_existing_file_equals():
    filepath = str(pathlib.Path(str(pytest.config.rootdir)) / 'test' / 'scap' / 'model' / 'test_xlink2.xml')
    c = host.load_collector('ResolveFilepathCollector', {
        'filepath': filepath,
        'value_datatypes': {'filepath': 'string'},
        'value_operations': {'filepath': 'equals'},
...
def test_not_existing_file_pattern():
    filepath = str(pathlib.Path(str(pytest.config.rootdir)) / 'test' / 'scap' / 'model' / 'test_xlink2.xml')
    regexfilepath = str(pathlib.Path(str(pytest.config.rootdir)) / 'test' / 'scap' / 'model' / '.*xlink2.xml').replace('\\', '\\\\')
    c = host.load_collector('ResolveFilepathCollector', {
        'filepath': regexfilepath,
        'value_datatypes': {'filepath': 'string'},
        'value_operations': {'filepath': 'equals'},
